...
public interface CarbonSqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitUnsupportedHiveNativeCommands(CarbonSqlBaseParser.UnsupportedHiveNativeCommandsContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitErrorCapturingMultiUnitsInterval(CarbonSqlBaseParser.ErrorCapturingMultiUnitsIntervalContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitErrorCapturingUnitToUnitInterval(CarbonSqlBaseParser.ErrorCapturingUnitToUnitIntervalContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitQualifiedColTypeWithPositionList(CarbonSqlBaseParser.QualifiedColTypeWithPositionListContext ctx);
	/**
